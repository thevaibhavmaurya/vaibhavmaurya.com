...
export function CodeCollapsibleWrapper({
  ...
  return (
    ...
    >
      ...
      <CollapsibleTrigger className="from-code absolute inset-x-0 bottom-0 flex h-24 items-end justify-center rounded-b-xl bg-linear-to-t from-25% to-transparent pb-4 text-sm font-medium text-muted-foreground group-data-[state=open]/collapsible:hidden">
        Expand
      </CollapsibleTrigger>
    </CollapsibleWithContext>
  );
