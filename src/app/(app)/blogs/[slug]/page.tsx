...
import { BlogKeyboardShortcuts } from "@/components/blog/blog-keyboard-shortcuts";
import { LLMCopyButtonWithViewOptions } from "@/components/blog/blog-page-actions";
import { BlogShareMenu } from "@/components/blog/blog-share-menu";
...
import { findNeighbour, getAllPosts, getPostBySlug } from "@/data/posts";
    ...
    <>
      ...
      <div className="flex items-center justify-between p-2 pl-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <BlogShareMenu url={getPostUrl(post)} />
...
function getPostUrl(post: Post) {
  ...
  return isComponent ? `/components/${post.slug}` : `/blogs/${post.slug}`;
}
